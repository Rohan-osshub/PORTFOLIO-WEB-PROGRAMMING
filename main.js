...
// Add this to your init3DModel function, after creating the renderer
const instructions = document.querySelector('.model-instructions');
let fadeTimeout;
...
container3D.addEventListener('mousemove', () => {
    instructions.style.opacity = '0';
    clearTimeout(fadeTimeout);
    fadeTimeout = setTimeout(() => {
        instructions.style.opacity = '0.8';
